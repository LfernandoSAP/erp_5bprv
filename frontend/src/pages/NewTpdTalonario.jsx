...
import { createTpdTalonario } from "../services/tpdTalonarioService";
...
function NewTpdTalonario({ onBack }) {
  ...
  async function loadPoliceOfficers() {
    try {
      ...
      console.error("Erro ao carregar policiais:", loadError);
    }
  }
  ...
  async function loadFleetVehicles(targetUnitId = "") {
    try {
      ...
      console.error("Erro ao carregar viaturas:", loadError);
    }
  }
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.error("Erro ao cadastrar TPD/Talonário:", submitError);
      setError(submitError.message || "Erro ao cadastrar TPD/Talonário.");
    }
  };
  ...
  return (
    <div style={styles.page}>
      <section style={styles.hero}>
        <h1 style={styles.title}>Novo TPD/Talonário</h1>
        <p style={styles.subtitle}>
          Selecione a categoria e preencha os dados de controle do TPD/Talonário.
        </p>
      ...
      <form onSubmit={handleSubmit} style={styles.card}>
        ...
        <p style={styles.sectionText}>
          Defina a categoria primeiro. Os demais campos serão exibidos conforme a seleção.
        </p>
        ...
        <div style={styles.formGrid}>
          <div style={styles.field}>
            ...
            <select
              value={category}
              onChange={(event) => resetFormBelowCategory(event.target.value)}
              required
              style={styles.input}
            >
...
export default NewTpdTalonario;
