...
import {
  ...
  getTpdTalonarios,
  searchTpdTalonarios,
} from "../services/tpdTalonarioService";
...
function TpdTalonarioList({ onBack, onNewItem, onEditItem, refreshKey }) {
  ...
  async function loadItems() {
    try {
      setError("");
      await runItemsRequest(() => getTpdTalonarios(false, effectiveUnitFilter));
    } catch (err) {
  ...
  const handleSearch = async () => {
    try {
      ...
      await runItemsRequest(() => searchTpdTalonarios(search, effectiveUnitFilter));
    } catch (err) {
  ...
  const confirmDelete = async () => {
    try {
      setError("");
      await deleteTpdTalonario(selectedItemId);
      setOpenDialog(false);
  ...
  return (
    <div style={styles.page}>
      <section style={styles.hero}>
        <h1 style={styles.title}>TPD/Talonário</h1>
        <p style={styles.subtitle}>
          Consulte, busque e administre os registros de TPD/Talonário cadastrados no sistema.
        </p>
      ...
      <section style={styles.card}>
        <h2 style={styles.sectionTitle}>Busca de TPD/Talonário</h2>
        <p style={styles.sectionText}>
          Pesquise por nome, modelo, categoria, número de série, patrimônio, local ou observação.
        </p>
        ...
        <div style={styles.actions}>
          ...
          <SearchInputAction
            ...
            placeholder="Buscar TPD/Talonário..."
            actionLabel="Buscar"
      ...
      <section style={styles.tableCard}>
        {viewingItem && (
          <section style={{ ...styles.card, margin: "20px 20px 0" }}>
            ...
            >
              <div>
                <h2 style={styles.sectionTitle}>Detalhes de TPD/Talonário</h2>
                <p style={styles.sectionText}>
                  Consulte os dados completos do registro selecionado.
                </p>
              </div>
        ...
        <div style={styles.tableHeader}>
          <div>
            <h2 style={styles.tableTitle}>Lista de TPD/Talonário</h2>
          ...
          <ReportExportButtons
            ...
            onExportExcel={() =>
              exportExcelReport({
                fileBaseName: "tpd-talonario",
                sheetName: "TPD_Talonario",
                title: "Relatório de TPD/Talonário",
        ...
        <div style={{ padding: "20px 20px 0" }}>
          <div style={styles.summaryGrid}>
            ...
            <div style={styles.summaryCard}>
              <p style={styles.summaryLabel}>Registros ativos</p>
              <p style={styles.summaryValue}>{activeVisibleItemsCount}</p>
            </div>
            <div style={styles.summaryCard}>
              <p style={styles.summaryLabel}>Registros inativos</p>
            ...
            <table style={styles.table}>
              ...
              {visibleItems.map((item, index) => (
                ...
                >
                  ...
                  <td style={{ ...styles.td, padding: "10px 12px", whiteSpace: "nowrap" }}>{item.unit_label ?? unitMap[item.unit_id] ?? item.unit_id}</td>
                  <td style={{ ...styles.td, padding: "10px 12px", whiteSpace: "nowrap" }}>
                    {buildCustodySummary({
                      custodyType: item.custody_type,
                      custodySectorName:
      ...
      >
        <DialogTitle sx={{ color: "var(--app-text)", fontWeight: 700 }}>
          Inativar TPD/Talonário
        </DialogTitle>
        <DialogContent>
          <DialogContentText>
            Tem certeza que deseja inativar este TPD/Talonário?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
      ...
      >
        <Alert severity="success" sx={{ width: "100%" }}>
          TPD/Talonário inativado com sucesso!
        </Alert>
      </Snackbar>
    </div>
  );
...
export default TpdTalonarioList;
