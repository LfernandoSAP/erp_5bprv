...
class LsvBloco(Base):
    __tablename__ = "lsv_blocos"
    __table_args__ = {"schema": "rh"}

    id = Column(Integer, primary_key=True, index=True)
    registro_id = Column(Integer, ForeignKey("rh.lsv_registros.id"), nullable=False, index=True)
    ...
    registro = relationship("LsvRegistro", back_populates="blocos")
